...
// 2. Ambil ID produk dari URL (dikirim dari product.php)
...
// Jika ID tidak valid atau produk tidak ditemukan, arahkan kembali ke halaman produk
if (!$data) {
  ...
  <?php include "include/footer.php"; ?>
    ...
    <script>
        ...
        function updateHarga() {
            ...
            // MENGGABUNGKAN RINCIAN 1 BARIS SESUAI PERMINTAAN SEBELUMNYA (DENGAN TAMPILAN LEBIH MODERN)
