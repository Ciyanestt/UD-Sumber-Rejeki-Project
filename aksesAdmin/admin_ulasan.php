...
<head>
    ...
    <title>Kelola Ulasan - UD. SUMBER REJEKI</title>
                ...
                <tr>
                    <td>
                        <div class="mb-1 d-flex align-items-center">
                            ...
                            <span class="fw-bold text-dark text-truncate" style="max-width: 140px;"><?= htmlspecialchars(
                                $pengirim,
                            ) ?></span>
                        </div>
                        <div class="text-nowrap mt-1">
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                ...
                                $row["rating"]
                                    ? "text-warning"
                                    : "text-body-tertiary" ?>" style="font-size: 0.8rem; margin-right: 1px;"></i>
                            <?php endfor; ?>
                            <small class="text-muted ms-1 fw-bold" style="font-size: 0.75rem;">(<?= $row[
                                "rating"
                            ] ?>/5)</small>
                        </div>
                    </td>
                    ...
                    <td>
                        <?php if ($row["foto_bukti"]): ?>
                            <a href="../uploads/<?= $row[
                                "foto_bukti"
                            ] ?>" target="_blank" class="btn duck-btn-photo btn-sm d-inline-flex align-items-center">
                    ...
                    <td>
                        <form action="" method="POST" class="m-0">
                            <input type="hidden" name="id_ulasan" value="<?= $row[
                                "id_ulasan"
                            ] ?>">
...
<?php unset($_SESSION["sukses_balas"]);endif; ?>
