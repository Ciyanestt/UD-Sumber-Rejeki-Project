...
<head>
    ...
    <style>
        ...
        .hero-section {
            background-color: var(--bg-clean);
            position: relative;
            /* UPDATE: Menghapus padding vertikal agar gambar bisa full ke atas/bawah jika perlu, 
               diatur ulang di container */
            padding: 0; 
            overflow: hidden;
            display: flex;
            align-items: center;
        ...
        /* UPDATE: Wrapper diubah agar mengisi penuh tinggi section dan rata kanan */
        .hero-image-wrapper {
            position: absolute; /* UPDATE: Ubah jadi absolute agar bisa full height */
            top: 0;
            right: 0;
            width: 45%; /* UPDATE: Samakan dengan lebar .hero-shape-deco */
            height: 100%;
            z-index: 2;
            display: flex;
            align-items: center;
            justify-content: flex-end; /* UPDATE: Rata kanan */
            padding: 0; /* Menghapus padding default col */
        }
        
        .hero-main-image {
            /* UPDATE: Diatur agar memenuhi wrapper (cover) */
            width: 100%;
            height: 100%;
            object-fit: cover; /* UPDATE: Agar gambar penuh tanpa distorsi */
            
            /* UPDATE: Radius disesuaikan agar serasi dengan shape deco (hanya kiri bawah) */
            border-radius: 0; 
            border-bottom-left-radius: 200px;
            
            /* UPDATE: Bingkai disesuaikan atau dihilangkan agar menyatu dengan shape */
            border: none;
            /* Bingkai tebal oranye dipindah ke sisi kiri saja sebagai aksen jika diinginkan, 
               atau dihilangkan agar menyatu total. Disini saya hilangkan agar menyatu penuh 
               sesuai permintaan "sebesar warna oren". */

            box-shadow: -10px 25px 55px rgba(0, 0, 0, 0.1); /* Shadow disesuaikan ke kiri */
        ...
        @media (max-width: 991px) {
            .hero-section { min-height: auto; padding-top: 100px; } /* Reset min-height */
            ...
            /* UPDATE: Kembalikan posisi wrapper ke alur normal (relative) di mobile */
            .hero-image-wrapper { 
                position: relative; 
                width: 100%; 
                height: auto; 
                margin-top: 50px; 
                justify-content: center;
                padding: 0 15px; /* Kembalikan padding col */
            }
            /* UPDATE: Kembalikan gaya gambar ke gaya sebelumnya di mobile agar tidak aneh */
            .hero-main-image { 
                width: 100%; 
                max-width: 480px; 
                height: auto; 
...
<body>
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-7 col-md-12 text-lg-start text-center" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="d-flex justify-content-lg-start justify-content-center gap-3 flex-wrap mt-5">
                        <a href="product.php" class="btn-premium btn-premium-dark shadow-premium">
                            Eksplor Produk <i class="bi bi-bag ms-2"></i>
                        </a>
                        <a href="mitra.php" class="btn-premium btn-premium-orange shadow-premium">
    ...
    <section class="container py-5 my-5">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6 col-md-12 ps-lg-5" data-aos="fade-left" data-aos-delay="200">
                ...
                <a href="aboutus.php" class="btn-premium btn-premium-orange mt-3 shadow-premium">
    ...
    <section class="product-section mt-5">
        <div class="container py-5">
            <div class="section-title-wrapper text-center mb-5" data-aos="fade-up">
                <h2 class="section-title-main text-navy">Produk Unggulan</h2>
            ...
            <div class="row g-5 justify-content-center align-items-start">
                <div class="col-lg-5 col-md-6" data-aos="fade-up" data-aos-delay="150">
                    <div class="card h-100 product-card-premium shadow-premium">
                        <span class="product-badge badge-shadow">Terlaris</span>
                        <div class="product-img-wrapper overflow-hidden">
                            <img src="pictures/daging itik utuh.png" class="card-img-top" alt="Daging Bebek Segar Utuh" />
                        </div>
                        <div class="product-body-premium">
                            <h4 class="card-title text-navy">Daging Bebek Segar</h4>
                            <p class="card-text text-secondary mt-3" style="font-weight: 500; line-height: 1.7;">
                                Daging bebek utuh, segar, dan bersih. Kualitas premium, daging tebal, dan siap olah. Sempurna untuk hidangan rumah tangga istimewa maupun kebutuhan usaha kuliner Anda.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 product-card-offset" data-aos="fade-up" data-aos-delay="300">
                    <div class="card h-100 product-card-premium shadow-premium">
                        <span class="product-badge badge-shadow">Premium</span>
                        <div class="product-img-wrapper overflow-hidden">
                            <img src="pictures/rempelo ati.png" class="card-img-top" alt="Jeroan Bebek Segar" />
                        </div>
                        <div class="product-body-premium">
                            <h4 class="card-title text-navy">Jeroan Bebek</h4>
                            <p class="card-text text-secondary mt-3" style="font-weight: 500; line-height: 1.7;">
                                Jeroan bebek segar, bersih, dan higienis siap masak. Kualitas premium untuk cita rasa masakan yang maksimal dan menggugah selera.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container py-5">
            <div class="contact-grid-wrapper shadow-premium">
                ...
                <div class="row g-4 justify-content-center relative z-1">
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="contact-card-premium">
                            ...
                            <h5 class="contact-title-card">(+62) 852 3684 0255</h5>
                            <p class="contact-text-card">
                                Layanan telepon dan WhatsApp kami siap membantu Anda dengan informasi cepat soal ketersediaan produk dan harga.
                            </p>
                        </div>
                    </div>
                ...
                <div class="text-center mt-5 pt-3 relative z-1" data-aos="fade-up">
                    <a href="contact.php" class="btn-premium btn-premium-orange shadow-premium">
    ...
    <section class="mitra-section text-center text-white mt-5">
        <div class="container py-4" data-aos="zoom-in-up" data-aos-duration="1000">
            ...
            <a href="mitra.php" class="btn-premium btn-premium-dark px-5 py-3 shadow-lg" style="font-size: 1rem;">
