...
// include "include/header.php"; // Header akan dipanggil di bawah tag <body>
...
<body>
    ...
    document.querySelectorAll('.rating-input').forEach(input => {
        input.addEventListener('change', function() {
            ...
            if (this.checked) {
                // Munculkan kolom isi pesan & foto
                detailContainer.style.display = 'block';
                // Animasi kecil agar form tampak natural munculnya
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const opsiObserver = {
                root: null,
                threshold: 0.1, // Trigger saat elemen terlihat 10%
            ...
            const observer = new IntersectionObserver(function (entries, observer) {
                entries.forEach(entry => {
                    if (entry.isIntersecting) {
                        ...
                        // Optional: observer.unobserve(entry.target); jika ingin animasi hanya sekali jalan.
                    }
                });
            }, opsiObserver);
