...
// QUERY DIPERBAIKI: Mengambil data utama langsung dari tabel pesanan milik admin
$query = mysqli_query(
    $conn,
    "SELECT p.*, prod.nama_produk as nama_produk_asli, p.status as status_pesanan 
    FROM pesanan p
    LEFT JOIN produk prod ON p.nama_produk = prod.nama_produk
    WHERE p.id_pesanan = '$id_pesanan' AND p.id_pelanggan = '$id_pelanggan'",
);
...
if (
    ...
    stripos($status, "diterima") !== false
) {
    $badge_class = "badge-diterima";
    $icon_class = "bi-check-circle-fill";
} elseif (
    stripos($status, "tolak") !== false ||
    stripos($status, "batal") !== false
) {
...
<head>
    ...
    <title>Detail Pesanan #<?= $data[
        "id_pesanan"
    ] ?> - UD. SUMBER REJEKI</title>
            ...
            <div class="col-md-8 col-lg-7">
                ...
                <div class="receipt-card p-4 p-md-5 fade-in-up">
                    ...
                    <div class="text-center mb-4 pb-3 border-bottom delay-1 fade-in-up">
                        ...
                        <h2 class="fw-bold text-dark mb-3">#<?= htmlspecialchars(
                            $data["id_pesanan"],
                        ) ?></h2>
                        <span class="status-badge <?= $badge_class ?>">
                            <i class="<?= $icon_class ?>"></i> <?= htmlspecialchars(
    $status,
) ?>
                        </span>
                    </div>
                    ...
                    <div class="row text-center mb-2 delay-2 fade-in-up">
                        <div class="col-12">
                            ...
                            <p class="value-custom fs-5"><?= date(
                                "d M Y • H:i",
                                strtotime($data["waktu_transaksi"]),
                            ) ?> WIB</p>
                        </div>
                    </div>
                    ...
                    <div class="delay-3 fade-in-up">
                        ...
                        <div class="d-flex justify-content-between align-items-center bg-light p-3 rounded-3 mt-3">
                            <div>
                                <p class="mb-1 fw-bold text-dark fs-5"><?= htmlspecialchars(
                                    $data["nama_produk_asli"],
                                ) ?></p>
                                <p class="label-custom mb-0"><?= $data[
                                    "jumlah"
                                ] ?> Item x Rp <?= number_format(
     $data["harga_satuan"],
     0,
     ",",
     ".",
                            ...
                            <div class="text-end">
                                <p class="fw-bold text-dark mb-0 fs-5">Rp <?= number_format(
                        ...
                        <div class="row mt-3 g-3">
                            <div class="col-sm-6">
                                <div class="p-3 border rounded-3 h-100">
                                    ...
                                    <p class="value-custom mb-0"><?= htmlspecialchars(
                    ...
                    <div class="delay-4 fade-in-up">
                        ...
                        <div class="total-box shadow-sm">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold">Rp <?= number_format(
                                    $data["jumlah"] * $data["harga_satuan"],
                                    0,
                                    ",",
                                    ".",
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="grand-total-text">Rp <?= number_format(
                                    $data["total_harga"],
                                    0,
                                    ",",
                                    ".",
