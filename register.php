            ...
            <form id="formRegister" method="POST" action="" novalidate>
                <div class="form-grid">
                    <div class="input-group">
                        ...
                        <input type="text" id="regNama" name="nama_lengkap" placeholder="Nama Anda" requiredpattern="[A-Za-z\s]+" title="Nama lengkap hanya boleh berisi huruf dan spasi." oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '')">
                    </div>
                    <div class="input-group">
