...
if (isset($_POST["login"])) {
    ...
    if (!$login_success) {
        ...
        if (mysqli_num_rows($result_p) > 0) {
            ...
            if (password_verify($password, $db_pass_p) || $password === $db_pass_p) {
    ...
    // Jika gagal, set flag error menjadi true (tidak memakai alert bawaan lagi)
    if (!$login_success) {
        $login_error = true;
    }
}
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if ($login_error): ?>
                Swal.fire({
                    ...
                    icon: 'error',
                    iconColor: '#e74c3c',
                    background: '#fdf6e3', /* Menyamakan warna dasar --cream */
                    color: '#2c3e50',      /* Menyamakan warna --navy */
                    confirmButtonColor: '#ff9f43', /* Menyamakan warna --orange */
