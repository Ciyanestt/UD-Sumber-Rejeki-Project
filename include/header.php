...
<body>
    <img src="pictures/logo.png" class="watermark-bg" alt="Logo Watermark">

    <!-- Navbar dengan Logika Role -->
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="index.php">
                <img src="pictures/logo.png" alt="Logo" style="height: 40px; margin-right: 10px;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <?php 
                    // Ambil role user saat ini (kosong jika belum login)
                    $role = isset($_SESSION['role']) ? $_SESSION['role'] : ''; 
                    ?>
                    <?php if ($role === 'admin'): ?>
                        <li class="nav-item"><a class="nav-link" href="product.php">PRODUCT</a></li>
                        <li class="nav-item"><a class="nav-link" href="admin_ulasan.php">PESAN</a></li>
                        
                        <li class="nav-item"><a class="nav-link" href="profil.php">PROFIL SAYA</a></li> 
                        
                        <li class="nav-item">
                            <a href="rekap.php" class="btn btn-danger btn-sm text-white fw-bold px-3 ms-2 rounded-pill" style="font-size: 0.75rem;">REKAP PENJUALAN</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-primary fw-bold" href="tambah_admin.php">
                                <i class="fa-solid fa-user-plus me-1"></i> Tambah Admin
                            </a>
                        </li>
                        <li class="nav-item ms-2">
                            <a class="nav-link text-danger fw-bold" href="logout.php" style="font-size: 0.75rem;"><i class="bi bi-box-arrow-right"></i> LOGOUT</a>
                        </li>
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item"><a class="nav-link" href="PesanKesan.php">PESAN</a></li>
                        <li class="nav-item"><a class="nav-link" href="contact.php">CONTACT US</a></li>

                        <?php if (isset($_SESSION["id_pelanggan"])): ?>
                            <li class="nav-item"><a class="nav-link" href="profil.php">PROFIL SAYA</a></li>
                            <li class="nav-item">
                                <a href="history.php" class="btn btn-warning btn-sm text-dark fw-bold px-3 ms-2 rounded-pill" style="font-size: 0.75rem;">HISTORY</a>
                            </li>
                            <li class="nav-item ms-2">
                                <a class="nav-link text-danger fw-bold" href="logout.php" style="font-size: 0.75rem;"><i class="bi bi-box-arrow-right"></i> LOGOUT</a>
                            </li>
                        <?php else: ?>
                            <li class="nav-item ms-lg-2"><a class="nav-link btn-login" href="login.php">LOGIN</a></li>
                            <li class="nav-item ms-2"><a class="nav-link btn-login" href="register.php">REGISTER</a></li>
                        <?php endif; ?>
